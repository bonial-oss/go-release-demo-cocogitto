...
Every release of `go-release-demo-cocogitto` is signed by
...
<https://github.com/bonial-oss/go-release-demo-cocogitto/releases/tag/v0.1.0>):
...
```bash
cosign verify-blob \
  --certificate-identity-regexp='^https://github.com/bonial-oss/go-release-demo-cocogitto/\.github/workflows/release\.yaml@refs/heads/main$' \
...
slsa-verifier verify-artifact \
  ...
  --source-uri github.com/bonial-oss/go-release-demo-cocogitto \
  --source-branch main \
...
```bash
git clone https://github.com/bonial-oss/go-release-demo-cocogitto
cd go-release-demo-cocogitto
git checkout v0.1.0
